...
function RadioGroupItem({
  ...
  return (
    <RadioGroupPrimitive.Item
      className={cn(
        'border-outline-variant dark:bg-surface-container-high/30 aspect-square size-5 shrink-0 items-center justify-center rounded-full border shadow-sm shadow-black/5',
        Platform.select({
